...
class Admin extends MY_Controller{
    ...
    //function to load add DM page
	public function addDm(){
		
		$this->load->view('add_dm');
	}
    
    // function to display Dm list
	...
	public function dm_register(){
		...
		if( $this->form_validation->run() == TRUE){
            ...
            //get userdata from register form
    		...
    		if($row_affected > 0){
                ...
                if($email !=''){
                    ...
                    $message = '<p style="color: #000;">Congratulations!! You have successfully registered an account on NSC Digital as DM.</p>';
