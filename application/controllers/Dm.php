...
class Dm extends MY_Controller{
	...
	//function to load DM profile
	public function index(){
		
		$this->load->view('dm_profile');
	}
    ...
    //function to load subdm register form
	public function addSubdm(){
		
		$this->load->view('add_subdm');
	}
    
    //function to display subdm list
	...
	//function to register subDM
	public function subdm_register(){
		...
		//upload photo of operator
			...
			$role = 4;
			//function to get input field data from post
    		...
    		if($row_affected > 0){
                ...
                if($email !=''){
                    ...
                    $message = '<p style="color: #000;">Congratulations!! You have successfully registered an account on NSC Digital as Sub-DM.</p>';
