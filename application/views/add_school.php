            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="">Add School</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart('Subdm/prinicipal_register',['class'=>'bs-component']); ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input(['name'=>'school_name','placeholder'=>'School Name','value'=>set_value('school_name'),'class'=>'form-control']); ?>
                                                <div style="color:red;"><small><?php echo form_error('school_name'); ?></small></div>
                                            </div>
                                        </div>                                  
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input(['name'=>'prinicipal_name','placeholder'=>'Prinicipal Name','value'=>set_value('prinicipal_name'),'class'=>'form-control']); ?>
                                                <div style="color:red;"><small><?php echo form_error('prinicipal_name'); ?></small></div> 
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Contact Number*</label>
                                                <?php echo form_input(['name'=>'contact_number','placeholder'=>'Contact number','value'=>set_value('contact_number'),'class'=>'form-control']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input(['name'=>'email','placeholder'=>'Email','value'=>set_value('email'),'class'=>'form-control']); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_password(['name'=>'password','placeholder'=>'Password','value'=>set_value('password'),'class'=>'form-control']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Address*</label>
                                                <?php echo form_input(['name'=>'address','placeholder'=>'Address','value'=>set_value('address'),'class'=>'form-control']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>City*</label>
                                                <?php echo form_input(['name'=>'city','placeholder'=>'City','value'=>set_value('city'),'class'=>'form-control']); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>State*</label>
                                                <?php echo form_input(['name'=>'state','placeholder'=>'State','value'=>set_value('state'),'class'=>'form-control']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 pr-1">
                                            <div class="form-group">
                                                <label class="btn btn-primary" style="color:#fff!important;" for="body">Upload Logo</label>
                                                <?php echo form_upload(['name'=>'userfile','value'=>set_value('userfile')]); ?>
                                                <div style="color:red;"><small><?php echo form_error('userfile'); ?></small></div>
