                        ...
                        <div class="card">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $marks = base_url('index.php/Operator/inputMarks/').$row->unique_id;
                                        echo '<a href="'.$marks.'" class="btn pt-2 pb-2 pl-3 pr-3" style="background-color:green;color:white;"><i class="fa fa-edit"></i></a>';
                                        
                                        ?>
                                    </td>
                                    <td><?=$row->marksheet_status?></td>
                                    <td>
                                        <?php
                                        ...
                                        echo '<a href="'.$modify.'" class="btn pt-2 pb-2 pl-3 pr-3" style="background-color:green;color:white;"><i class="fa fa-user"></i></a>';
