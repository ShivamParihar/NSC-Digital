                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title">Accountant Profile</h5>
                            </div>
                            <div class="card-body">
                                <?php echo form_open('Editupdate/updateFromProfile',['class'=>'bs-component']); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input(['name'=>'admission_date','type'=>'date','value'=>$this->session->userdata('admission_date'),'class'=>'form-control']); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Salary</label>
                                                <?php echo form_input(['name'=>'fee_salary','value'=>$this->session->userdata('fee_salary'),'class'=>'form-control']); ?>
