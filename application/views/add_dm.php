    ...
    -->
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="<?= base_url('index.php/Admin/addDm') ?>">
                            <i class="now-ui-icons design_app"></i>
                            <p>Add DM</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('index.php/Admin/list1') ?>">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="">Add DM</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <p class="navbar-brand">Officer</a>
                            </li>    
                            <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart('Admin/dm_register',['class'=>'bs-component']); ?>
                                    <div class="row">
                                        <div class="col-md-12">
