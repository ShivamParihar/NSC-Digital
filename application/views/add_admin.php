            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="">Add Officer</a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart('Superadmin/adminRegister',['class'=>'bs-component']); ?>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 pr-1">
                                            <div class="form-group">
                                                <label class="btn btn-primary" style="color:#fff!important;" for="body">Upload image</label>
                                                <?php echo form_upload(['name'=>'profile_img_path','value'=>set_value('profile_img')]); ?>
                                                <div style="color:red;"><small><?php echo form_error('profile_img'); ?></small></div>
                                                <div style="color:red;font-size:30px;z-index:1000;"><small><?php if(isset($upload_error)) { echo $upload_error; }?></small></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 pr-1">
                                            <div class="form-group">
                                                <label class="btn btn-primary" style="color:#fff!important;" for="body">Upload signature</label>
                                                <?php echo form_upload(['name'=>'sign_img_path','value'=>set_value('sign_img')]); ?>
                                                <div style="color:red;"><small><?php echo form_error('sign_img'); ?></small></div>
                                                <div style="color:red;font-size:30px;z-index:1000;"><small><?php if(isset($upload_error)) { echo $upload_error; }?></small></div>
                                            </div>
                                        </div>
                                    </div>
