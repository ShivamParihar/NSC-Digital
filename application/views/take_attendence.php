                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo form_open('Sendlist/getListTakeAttendence'); ?>
                                    <div class="row">
                                        <div class="col-md-12">
                            ...
                            <tbody>
                                <?php echo form_open_multipart('Operator/storeAttendence',['class'=>'bs-component']); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row->section ?></td>
                                    <td>
                                            <input type="radio" name="<?=$row->unique_id ?>" value="1">Present<br>
                                            <input type="radio" name="<?=$row->unique_id ?>" value="0" checked>Absent<br>
