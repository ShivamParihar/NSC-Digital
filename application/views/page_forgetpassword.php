...
<div class="bg">
	...
	<div class="form" style='background-color:#fff;'>
        ...
        <?php echo form_open('Resetpassword/sendSMS'); ?>
            ...
            <p class="err"><?= $error ?></p>
                ...
                <input class="button" type="submit" value="Confirm" style="margin-bottom: 20px;">
        </form>
        <a href="logincontroller" style="text-decoration:none;color:#0080ff"><small>Login</small></a><br/><br/>
   	</div>
</div>
